 ...
 */
$current_entity = izap_get_current_entity();

// Set title
if (empty($current_entity->title)) {
  $meta_title = elgg_get_plugin_setting('index_metatitle', 'izap-seo');
} else {
  $meta_title = $current_entity->izap_title;
}
if (empty($meta_title)) {
  if (empty($vars['title'])) {
